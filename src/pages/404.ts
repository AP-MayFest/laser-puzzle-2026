...
new Runtime(
    'status',
    {
        ...
        placements: [
            ...
            { position: new Vec2(15,1), movable: true, descriptor: { kind: "polarizing-beam-splitter", direction: "NE" } },
            ...
            { position: new Vec2(15,2), movable: true, descriptor: { kind: "polarizer", direction: "S", polarity: "S" } },
            ...
            { position: new Vec2( 7,3), movable: true, descriptor: { kind: "polarizer", direction: "S", polarity: "D" } },
            ...
            { position: new Vec2(15,3), movable: true, descriptor: { kind: "polarizer", direction: "S", polarity: "D" } },
            ...
            { position: new Vec2( 5,4), movable: true, descriptor: { kind: "polarizer", direction: "W", polarity: "D" } },
            { position: new Vec2( 7,4), movable: true, descriptor: { kind: "double-sided-mirror", direction: "NE" } },
            { position: new Vec2(12,4), movable: true, descriptor: { kind: "polarizing-beam-splitter", direction: "SW" } },
            { position: new Vec2(13,4), movable: true, descriptor: { kind: "polarizer", direction: "E", polarity: "D" } },
            { position: new Vec2(15,4), movable: true, descriptor: { kind: "polarizing-beam-splitter", direction: "SW" } },
            { position: new Vec2( 7,5), movable: true, descriptor: { kind: "polarizer", direction: "S", polarity: "S" } },
